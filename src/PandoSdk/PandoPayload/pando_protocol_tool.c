...
static int check_pdbin_header(struct mqtt_bin_header *bin_header);
static int init_device_header(struct device_header *header, struct mqtt_bin_header *bin_header,
    uint16_t payload_type, uint16_t payload_len);
static int init_pdbin_header(struct mqtt_bin_header *bin_header, struct device_header *header);
